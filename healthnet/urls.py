...
urlpatterns = [
                  ...
                  url(r'^create_test_result/(?P<pk>\d+)/(?P<id>[\w|\W]+)/$', views.create_test_result,
                      name="create_test_result"),
                  url(r'^create_test_result/(?P<pk>\d+)/', views.create_test_result, name="create_test_result"),
                  url(r'^create_prescription/(?P<pk>\d+)/(?P<id>[\w|\W]+)/$', views.create_prescription,
                  ...
                  url(r'^statistics/(?P<pk>\d+)/(?P<start>\d{2}-\d{2}-\d{4})/(?P<end>\d{2}-\d{2}-\d{4})$',
